...
}, 'patched-v3.17.0', {"requires": ["yui-base"]});
...
}, 'patched-v3.17.0', {"requires": ["get", "features"]});
...
}, 'patched-v3.17.0', {"requires": ["loader-base"]});
...
YUI.add('yui', function (Y, NAME) {}, 'patched-v3.17.0', {
    "use": [
        "yui-base",
        "get",
        "features",
...
YUI.add('aui', function (A, NAME) {}, '3.0.0pr2');
