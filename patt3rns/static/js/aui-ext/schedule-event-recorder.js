function initCustomScheduleEventRecorder($, A) {
    /**
        ...
        prototype: {
            ...
            hidePopover: function () {
                ...
                if (instance.currentPopover) {
                    console.log("currentPopover was found and is being destroyed");
                    instance.currentPopover.popover("destroy");
                }
                console.groupEnd();
            },
            ...
            showPopover: function (node) {
                ...
                instance.currentPopover = $element.popover({
                    ...
                    container: "body",
                    content: "Test",
                    template: $(".schedule-template").get(0).outerHTML
                });

                //instance.popover.set("align.node", node);
                instance.currentPopover.popover("show");
